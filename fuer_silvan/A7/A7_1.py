...
class MagicDrawingBoard:
    ...
    def pixel(self, coordinate):
        if coordinate[0] not in range(0, self.x) or coordinate[1] not in range(0, self.y):
    ...
    def rect(self, coordinate1, coordinate2):
        if coordinate1[0] not in range(0, self.x) or coordinate1[1] not in range(0, self.y):
            raise Warning("Coordinates out of bounds")
        elif coordinate2[0] not in range(0, self.x + 1) or coordinate2[1] not in range(0, self.y + 1):
            raise Warning("Coordinates out of bounds")
        elif coordinate2[0]- coordinate1[0] <= 0 or coordinate2[1] - coordinate1[1] <= 0:
